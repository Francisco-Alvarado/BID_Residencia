...
public class PantallaAlumnoRegistro extends javax.swing.JFrame {
  
    PlaceHolder holder;

    public PantallaAlumnoRegistro() {
        initComponents();
        placeHolder();
    }
    ...
    private void initComponents() {
        ...
        btn_regist = new org.edisoncor.gui.button.ButtonAction();
        ...
        btn_regist.setBackground(new java.awt.Color(153, 0, 0));
        btn_regist.setText("Registrarse");
        btn_regist.setDistanciaDeSombra(0);
        ...
        txt_contrasenaReg.setToolTipText("Contraseña de 3 digitos (abarca del 1 al 9)");
        ...
        txt_informacion.setText("Pasa tu credencial por el lector de código de barras, posteriormente confirma tu matricula e ingresa una contraseña para registrarte");
        ...
        panelShadow2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelShadow2Layout.createSequentialGroup()
                ...
                .addGroup(panelShadow2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(btn_regist, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE)
        ...
        panelShadow2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelShadow2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btn_regist, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        lbl_head.setText("REGISTRO DE ALUMNO");
        ...
        jLabel1.setText("Crea una contraseña de 3 digitos (digitos permitidosdel 1 al 9)");
    ...
    private void btn_registActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registActionPerformed
        if ("Credencial / NºControl".equals(txt_usuarioReg.getText()) || "●●●".equals(txt_contrasenaReg.getText())) {
            JOptionPane.showMessageDialog(null, "Campo vacío");
        } else {
            try {
                int usuarioVar = Integer.parseInt(txt_usuarioReg.getText());
                int contrasenaVar = Integer.parseInt(txt_contrasenaReg.getText());
                if(objeto.BuscarEnAlumnosITNL(usuarioVar) == true){
                    if (objeto.BuscarAnteriorRegistro(usuarioVar) == true) {
                    RegLogg.extraerDatos(usuarioVar, contrasenaVar);
                    txt_usuarioReg.setText("");
                    txt_contrasenaReg.setText("");
                     RegLogg.mensajeRegistrado();
                    pantAlumIngre.setVisible(true);
                    placeHolder();
                    this.dispose();
                } else {
                    JOptionPane.showMessageDialog(null, "Ya existe un alumno registrado \n  con el N° de conotrol " + usuarioVar);
                }
                    
                }
                
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "No se establece la conexión prro"
    ...
    txt_contrasenaReg.requestFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaAlumnoRegistro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
    ...
    private org.edisoncor.gui.button.ButtonAction btn_regist;
    ...
    public static PantallaAlumnoRegistro PantAlumRegis = new PantallaAlumnoRegistro();
    public static PantallaAlumnoIngreso pantAlumIngre = new PantallaAlumnoIngreso();
    public static RegistrarLogica RegLogg = new RegistrarLogica();
